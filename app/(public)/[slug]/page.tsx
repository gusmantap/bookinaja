...
export default async function BusinessProfilePage({
  ...
  const business = dummyBusinesses[slug];
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className={`bg-white ${borderRadius} shadow-sm border border-zinc-200 p-6`}>
                ...
                <p className="text-zinc-600 leading-relaxed">{business.bio}</p>
            ...
            <div className="lg:col-span-1 space-y-6">
              {/* Booking Form */}
              <BookingForm business={business} theme={theme} />
                ...
                <div className="space-y-2">
                  {business.operatingHours && Object.entries(business.operatingHours).map(([day, hours]) => (
                    <div key={day} className="flex justify-between text-sm">
                      <span className={`${fontWeight} text-zinc-700`}>{day}</span>
              ...
              <div className={`bg-white ${borderRadius} shadow-sm border border-zinc-200 p-6`}>
                ...
                <div className="space-y-3">
                  {business.email && (
                    <a href={`mailto:${business.email}`} className={`flex items-center gap-3 text-sm text-zinc-600 hover:text-${theme.accentColor}-600 transition`}>
