        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 -mt-20 pb-12">
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              {/* Booking Form */}
              <BookingForm business={businessData} theme={theme} isOwner={isOwner} />
              ...
              <div className={`bg-white ${borderRadius} shadow-sm border border-zinc-200 p-6`}>
                ...
                {businessData.email || businessData.instagram ? (
                  <div className="space-y-3">
                    {businessData.email && (
                  ...
                  <div className="text-sm text-zinc-500 bg-zinc-50 border border-dashed border-zinc-200 rounded-xl p-4 text-center">
                    Kontak belum tersedia. Silakan gunakan tombol booking atau kunjungi langsung lokasi kami.
                  </div>
                )}
              </div>
            </div>
